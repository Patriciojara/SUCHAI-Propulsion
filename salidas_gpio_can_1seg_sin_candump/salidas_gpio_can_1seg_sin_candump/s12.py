...
CMD_OUTPUT_ON = "cansend can0 100##1010C190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##1010C190000000000"
...
def main():
    print("========================================")
    print("Activando S12 / pin STM32 PB3")
