...
CMD_OUTPUT_ON = "cansend can0 100##1010E190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##1010E190000000000"
...
def main():
    print("========================================")
    print("Activando S14 / pin STM32 PD15")
