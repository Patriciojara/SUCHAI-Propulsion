...
CMD_OUTPUT_ON = "cansend can0 100##10110190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##10110190000000000"
...
def main():
    print("========================================")
    print("Activando S16 / pin STM32 PB11")
