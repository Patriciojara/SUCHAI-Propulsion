...
CMD_OUTPUT_ON = "cansend can0 100##1010D190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##1010D190000000000"
...
def main():
    print("========================================")
    print("Activando S13 / pin STM32 PC6")
