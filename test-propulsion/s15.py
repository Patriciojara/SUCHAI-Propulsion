...
CMD_OUTPUT_ON = "cansend can0 100##1010F190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##1010F190000000000"
...
def main():
    print("========================================")
    print("Activando S15 / pin STM32 PD14")
