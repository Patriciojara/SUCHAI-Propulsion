...
CMD_OUTPUT_ON = "cansend can0 100##10101190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##10101190000000000"
...
def main():
    print("========================================")
    print("Activando S1 / pin STM32 PA10")
