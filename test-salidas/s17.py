...
CMD_OUTPUT_ON = "cansend can0 100##10111190000008813"
CMD_OUTPUT_OFF = "cansend can0 100##10111190000000000"
...
def main():
    print("========================================")
    print("Activando S17 / pin STM32 PE14")
